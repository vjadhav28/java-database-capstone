...
public class AppointmentDTO {
    ...
    private java.time.LocalTime appointmentTimeOnly;
    private java.time.LocalDateTime endTime;

    public AppointmentDTO(Long id, Long doctorId, String doctorName, Long patientId, String patientName, String patientEmail, String patientPhone, String patientAddress, java.time.LocalDateTime appointmentTime, int status) {
        this.id = id;
